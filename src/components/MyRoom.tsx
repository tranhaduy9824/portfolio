  ...
  return (
    <group {...props} dispose={null}>
      ...
      <group position={[1.019, 0.497, -0.539]}>
        ...
        <group position={[0.007, 0.024, -0.002]} rotation={[Math.PI, -1.567, Math.PI]} scale={0.81}>
          <mesh
            castShadow
            receiveShadow
      ...
      <group position={[0.864, 0.748, -0.516]}>
        ...
        <group position={[2.485, -0.079, -2.249]} rotation={[Math.PI, 0, Math.PI]} scale={0.655}>
          <mesh
            castShadow
            receiveShadow
      ...
      <group position={[0.896, 1.765, -0.206]}>
        <group position={[0, 0, 0.002]} rotation={[0, 0, -Math.PI]} scale={-0.127}>
          ...
          <mesh
            ...
            material={materials.Cobertura_do_solo_de_lascas_de_madeiras_variadas}
          />
        </group>
        ...
        <group position={[0, 0, 0.054]}>
          <group rotation={[-Math.PI, 0, -Math.PI]} scale={1.36}>
            ...
            <mesh
              ...
              material={materials.borda_livro_capa_steve_jobst_sdfs0w5415ss5s5aaa}
            />
          </group>
          <mesh
            castShadow
      ...
      <group position={[-30.017, -0.33, -16.328]}>
        ...
        <group position={[0, 0.146, -8.405]}>
          <group position={[31.465, 0.954, 24.374]} rotation={[1.864, -0.194, 2.566]} scale={0.034}>
            <mesh
              castShadow
              receiveShadow
